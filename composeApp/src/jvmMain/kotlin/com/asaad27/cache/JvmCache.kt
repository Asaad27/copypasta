package com.asaad27.cache

import com.asaad27.cache.strategy.EvictionStrategy
import com.asaad27.cache.strategy.LruStrategy
import org.slf4j.LoggerFactory
import java.util.concurrent.ConcurrentHashMap

class JvmCache<K, V>(private var evictionStrategy: EvictionStrategy<K, V>, private val capacity: Int = 500) {
